from TD3.models.env import GazeboEnv
import numpy as np
import time
file_name = "../model"
...
id = 2
if id == 1:
    from TD3.pytorch_models.td3_net import TD3
    network = TD3()
    network.load(file_name, directory="./baseline_model/final_models")

if id == 2:
    from TD3.pytorch_models.attention_net import TD3
    network = TD3()
    network.load(file_name, directory="./attention_model/final_models")

if id == 3:
    from TD3.pytorch_models.gru_net import TD3
    network = TD3()
